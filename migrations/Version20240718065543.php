...
final class Version20240718065543 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id UUID NOT NULL, status VARCHAR(10) NOT NULL, level VARCHAR(10) NOT NULL, board TEXT NOT NULL, winner VARCHAR(10) DEFAULT NULL, players SMALLINT NOT NULL, game_completed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
